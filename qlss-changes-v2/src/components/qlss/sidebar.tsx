...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/profile", label: "profile page", icon: Palette },
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`px-2 py-1 text-xs transition-colors whitespace-nowrap inline-flex items-center gap-1.5 ${
                  active
